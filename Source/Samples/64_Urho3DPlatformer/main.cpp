...
public:
    ...
    virtual void Setup()
    {
		engineParameters_[EP_RESOURCE_PATHS] = "Data/Urho3DPlatformer;Data;CoreData;";
		engineParameters_[EP_LOG_NAME] = GetSubsystem<FileSystem>()->GetProgramDir() + "Urho3DPlatformer.log";
        engineParameters_[EP_FULL_SCREEN]=false;
        engineParameters_[EP_WINDOW_WIDTH]=1280;
        engineParameters_[EP_WINDOW_HEIGHT]=720;
        engineParameters_[EP_WINDOW_RESIZABLE]=true;
		engineParameters_[EP_WINDOW_TITLE] = "Urho3DPlatformer";
...
URHO3D_DEFINE_APPLICATION_MAIN(USP);
